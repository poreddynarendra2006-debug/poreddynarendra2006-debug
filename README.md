...
CS (Data Science) undergrad @ GITAM University · Class of 2027

[![LinkedIn](https://img.shields.io/badge/LinkedIn-0A66C2?style=for-the-badge&logo=linkedin&logoColor=white)](https://linkedin.com/in/narendra2006)
[![Email](https://img.shields.io/badge/Email-D14836?style=for-the-badge&logo=gmail&logoColor=white)](mailto:poreddynarendra2006@gmail.com)
[![GitHub](https://img.shields.io/badge/GitHub-181717?style=for-the-badge&logo=github&logoColor=white)](https://github.com/poreddynarendra2006-debug)
...
**[Smart Complaint & Issue Resolution Platform](https://github.com/poreddynarendra2006-debug)**
`TypeScript` `Next.js` `AWS CDK` `Lambda` `DynamoDB` `Cognito`
Full-stack complaint management system with Cognito auth (ADMIN/USER roles), DynamoDB single-table design, and CDK-provisioned infra deployed via AWS Amplify CI/CD.

**Crop AI – Soil Health Crop Recommendation System**
`Python` `FastAPI` `Scikit-learn` `Kotlin` `MVVM`
Random Forest classifier (~98.6% accuracy) served via FastAPI, consumed end-to-end by a Kotlin/MVVM Android app. Led a 4-person team across ML, API, and mobile.
